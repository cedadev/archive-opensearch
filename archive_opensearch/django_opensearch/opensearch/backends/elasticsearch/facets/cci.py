...
from archive_opensearch.ceda_opensearch.opensearch_settings import EXTERNAL_DATA_SOURCES
...
from archive_opensearch.django_opensearch.opensearch.utils import thredds_path
import os
...
class CCIFacets(ElasticsearchFacetSet):
    ...
    LOOKUP_HANDLER = 'archive_opensearch.django_opensearch.opensearch.lookup.cci_lookup.CCILookupHandler'
