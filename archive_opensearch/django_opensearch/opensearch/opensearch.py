...
import math
from archive_opensearch.django_opensearch.opensearch.backends import NamespaceMap
from importlib import import_module

# Import required backend
backend = import_module(f'archive_opensearch.django_opensearch.opensearch.backends.{settings.OPENSEARCH_BACKEND}')
