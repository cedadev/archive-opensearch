...
import os
from django_opensearch_nested.constants import DEFAULT
from django_opensearch_nested.opensearch.backends import NamespaceMap, Param, FacetSet
from django_opensearch_nested import settings
from .elasticsearch_connection import ElasticsearchConnection
import copy
from dateutil.parser import parse as date_parser
from django_opensearch_nested.opensearch.utils import NestedDict
from django_opensearch_nested.opensearch.utils.geo_point import Point, Envelope
from collections import namedtuple
from django_opensearch_nested.opensearch.utils.aggregation_tools import get_thredds_aggregation, get_aggregation_capabilities, \
...
class ElasticsearchFacetSet(FacetSet):
    ...
    def build_collection_entry(self, hit, params, base_url):
        ...
        if source.get('variable'):
            entry['properties']['variable'] = self._extract_variables(source['variable'])
