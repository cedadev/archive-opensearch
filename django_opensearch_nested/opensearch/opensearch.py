...
import math
from django_opensearch_nested.opensearch.backends import NamespaceMap
from importlib import import_module

# Import required backend
backend = import_module(f'django_opensearch_nested.opensearch.backends.{settings.OPENSEARCH_BACKEND}')
